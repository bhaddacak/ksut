...
By the fact that several roots behave distinctively due to certain paccayas, I therefore summarize some notable roots in Table \ref{tab:roots-kita-irr} at the end of the chapter. 
...
\example[0]{visesena bhavatīti vibhū (vi + \paliroot{bhū} + kvi) \\{\upshape= [One] exists by superiority, hence \pali{vibhū}.}}
