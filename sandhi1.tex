...
\transnote{\pali{Akkharāpādayo} can be cut as \pali{akkharā + pi + a + ādayo}. In the definition, \pali{sopakārā} is \pali{sa + upakārā} (see \hyperref[sut:14]{Kacc 14} below). Most particles in this sentence have little meaning, so left out. All 41 letters can be arranged in groups as shown in Table \ref{tab:letters}.}
...
see sutta \ref{sut:11} on page \pageref{sut:11}
