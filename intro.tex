...
Concerning apostrophes in the formulas, in comparison with other editions (some use a lot, some use none), I do use the mark but in a frugal way. The only condition that an apostrophe appears is when the beginning \pali{a} of the latter part of the sandhi is dropped. This is more or less like the use of \pali{avagraha} in Devanāgarī Sanskrit.\footnote{In Whit 1\S16, it is said avagraha is used for the elision of initial \pali{a} after \pali{e} and \pali{o}. But here \pali{a} after any vowel can be the case.} For example, the formula in \hyperref[sut:344]{Kacc 344} is \pali{vā ṇa’pacce}. This should be read as \pali{vā ṇa apacce}.
