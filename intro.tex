...
Concerning single-quote marks in the formulas, in comparison with other editions (some use a lot, some use none), I do use the mark but in a frugal way. The only condition that a single-quote mark appears is when the beginning \pali{a} of the latter part of the sandhi is dropped. This is then like the use of \pali{avagraha} in Devanāgarī Sanskrit. For example, the formula in \hyperref[sut:344]{Kacc 344} is \pali{vā ṇa’pacce}. This should be read as \pali{vā ṇa apacce}.
