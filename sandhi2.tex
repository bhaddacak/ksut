...
\transnote{We can break the formula to \pali{yaṃ + e + antassa + ādeso}. The \pali{d} is an extra insertion (see \hyperref[sut:35]{Kacc 35}).}
...
\transnote{We can break the formula to \pali{vaṃ + o + u + antānaṃ}.}
