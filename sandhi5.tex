...
\transnote{In the formula, we can break \pali{puthaiccetassa} to \pali{putha + iti + etassa}. The \pali{iti} and \pali{eta} add no specific meaning. This sutta is an example of a treatment of a single peculiar instance.}
...
\transnote{In the formula, \pali{puthassu} can be broken to \pali{puthassa + u}.}
...
\sutdeftrans{[The uses of] prefixes and particles not specified [previously] should be applied as said by the sandhis of vowel, consonant, and niggahita.}
