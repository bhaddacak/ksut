...
\transnote{A little better, now we know that the term is used to name some particles and prefixes. Precisely, there are four of them, i.e., \pali{pati}, \pali{pari}, \pali{abhi}, and \pali{anu}, which be able to use independently. Here is the definition of the term from the same place.}
...
\transnote{In the second example, the logic seems reverse. But Rūpa 328 asserts the meaning by ``\pali{brahmadattissarā pañcālāti attho}.'' In a straight form, it should be ``\pali{adhi pañcalesu brahmadatto},'' though.}
