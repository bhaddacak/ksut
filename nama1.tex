...
\transnote{In Rūpa 61, it is \pali{liṅgañca nipaccate} instead.}
...
\transnote{Vibhattis come in pairs (for singular and plural nouns) for seven cases plus vocative (\pali{ālapana}).\footnote{In fact, ālapana is just a special case of paṭhamā vibhatti used for addressing only. See \hyperref[sut:285]{Kacc 285}.} All these are summarized in Table \ref{tab:vibhat-nam}.}

\begin{table}[!hbt]
\centering
\caption{Vibhattis for nouns}
\label{tab:vibhat-nam}
\bigskip
...
\sutdef{dviiccevamādito saṅkhyāto nakārāgamo hoti naṃmhi vi\-bh\-attimhi.}
...
\head{75}{75, 170. avaṃmhi ca.}
\headtrans{Also \pali{ava}-substitution because of \pali{aṃ}[-vibhatti].}
\sutdef{goiccetassa okārassa āvaavaiccete ādesā honti aṃmhi vi\-bh\-attimhi.}
...
\head{82}{82, 149. aṃ mo niggahitaṃ jhalapehi.}
...
\head{83}{83, 67. saralopo’mādesapaccayādimhi saralope tu pakati.}
...
\head{98}{98, 189. mātulādīnamānattamīkāre.}
