...
\transnote{Vibhattis come in pairs (for singular and plural nouns) for seven cases plus vocative (\pali{ālapana}).\footnote{In fact, ālapana is just a special case of paṭhamā vibhatti used for addressing only. See \hyperref[sut:285]{Kacc 285}.} All these are summarized in Table \ref{tab:vibhatti}.}
